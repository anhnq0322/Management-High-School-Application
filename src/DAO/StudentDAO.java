...
public class StudentDAO extends DatabaseConnection {
    ...
    public boolean addStudent(Student student) {
        ...
        open();
        String sql = "INSERT INTO Student (Student_ID, Student_Name, Date_Of_Birth, Gender, Phone, Email, Address, Status, Image) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try {
            PreparedStatement pstm = conn.prepareStatement(sql);
    ...
    public boolean editStudent(Student student) {
        boolean result = false;
        open();
        String sql = "UPDATE STUDENT SET Student_Name = ?, Date_Of_Birth = ?, Gender = ?, Phone = ?, Email= ?, Address= ? ,Image = ? WHERE Student_ID = ?";
        try {
            PreparedStatement pstm = conn.prepareStatement(sql);
